...
// Los otros procesos necesitaran matA,  matB y matC
if (__taskid != 0) {
...
// #pragma omp cluster gather(matA[fA*cA]:chunk(cA))  // con chunk 
{ 
...
// #pragma omp cluster gather(matC[fA*cB]:chunk(cB))  // con chunk 
{ 
