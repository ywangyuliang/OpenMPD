...
// printf("Task %d: start %d, end %d step %d (__c_max %d)\n", __taskid, __start, __end, __step, __c_max);
...
//printf("Task %d: __counts_r[%d]: %d __displs_r[%d]: %d\n", __taskid, i, __counts_r[i], i, __displs_r[i]);
    }
  }
  else {
...
//printf("Task %d: __counts_r[%d]: %d __displs_r[%d]: %d\n", __taskid, __taskid, __counts_r[__taskid], __taskid, __displs_r[__taskid]);
  }
...
//printf("Task %d: __counts_g[%d]: %d __displs_g[%d]: %d\n", __taskid, i, __counts_g[i], i, __displs_g[i]);
    }
  }
  else {
...
//printf("Task %d: __counts_g[%d]: %d __displs_g[%d]: %d\n", __taskid, __taskid, __counts_g[__taskid], __taskid, __displs_g[__taskid]);
  }
...
// printf("Task %d: __counts_b[%d]: %d __displs_b[%d]: %d\n", __taskid, i, __counts_b[i], i, __displs_b[i]);
    }
  }
  else {
...
// printf("Task %d: __counts_b[%d]: %d __displs_b[%d]: %d\n", __taskid, __taskid, __counts_b[__taskid], __taskid, __displs_b[__taskid]);
  }
