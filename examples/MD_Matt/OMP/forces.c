...
#pragma omp parallel for simd shared(npart3,inf,sup,rcof2,side,vir, epot) private(i,j,xi,yi,zi,xx,yy,zz,rd,rrd,rrd3,rrd4,r148,fxi,fyi,fzi) schedule(dynamic) reduction(+:epot, vir)
